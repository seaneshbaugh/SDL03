...
SDLK_SCANCODE_MASK = bit32.lshift(1, 30)

function SDL_SCANCODE_TO_KEYCODE(x)
    return bit32.bor(x, SDLK_SCANCODE_MASK)
end
...
KMOD_CTRL = bit32.bor(KMOD_LCTRL, KMOD_RCTRL)
KMOD_SHIFT = bit32.bor(KMOD_LSHIFT, KMOD_RSHIFT)
KMOD_ALT = bit32.bor(KMOD_LALT, KMOD_RALT)
KMOD_GUI = bit32.bor(KMOD_LGUI, KMOD_RGUI)
