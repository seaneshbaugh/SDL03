    ...
    namespace Scene {
        namespace Cutscenes {
            namespace Actions {
                ...
                void AddActor::Start() {
                    this->map->AddActor(this->id, this->name, this->spritesheetName, this->dialogueId, this->x, this->y, this->direction, this->movementScriptName, this->interactionScriptName);
                }
