...
namespace Game {
    namespace Objects {
        ...
        public:
            Text();
            Text(std::string text, std::shared_ptr<Resources::Font> font, const int x, const int y, SDL_Color color, SDL_Rect location);
            ~Text();
            std::string GetText();
...
//
//                std::string text = "";
//                std::string fontName = Resources::Font::DEFAULT_FONT_NAME;
//                int fontSize = Resources::Font::DEFAULT_FONT_SIZE;
//                int x = 0;
//                int y = 0;
//                Uint8 red = 255;
//                Uint8 green = 255;
...
//
//                const std::shared_ptr<Resources::Font> font = Services::Locator::FontService()->GetFont(fontName, fontSize);
//
