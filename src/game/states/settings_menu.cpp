...
namespace Game {
    namespace States {
        ...
        Transition SettingsMenu::Update(const float deltaTime) {
        ...
        std::string SettingsMenu::ProcessInput(const Input::Button key) {
        ...
        void SettingsMenu::LuaInterface::Bind(std::shared_ptr<sol::state> luaState) {
            ...
            states.new_usertype<SettingsMenu>("SettingsMenu",
                                              ...
                                              "processInput", static_cast<std::string (SettingsMenu::*)(const Input::Button)>(&SettingsMenu::ProcessInput)
                                              );
        }
    }
}
