...
#include "../include/LoggerCpp/Log.h"
#include "../include/LoggerCpp/Logger.h"
...
const char* Log::toString(Log::Level aLevel) {
    ...
    switch (aLevel) {
        case Log::eDebug:   pString = "DEBUG"; break;
        case Log::eInfo:    pString = "INFO"; break;
        case Log::eNotice:  pString = "NOTE"; break;
        case Log::eWarning: pString = "WARNING"; break;
        case Log::eError:   pString = "ERROR"; break;
        case Log::eCritic:  pString = "CRITICAL"; break;
